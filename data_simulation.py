...
astronauts = [
    {"name": "Pedro", "role": "FE-1(EV1)", "age": 50, "gender": "Female", "status": "Normal"},
    {"name": "Mateus", "role": "FE-3(EV2)", "age": 45, "gender": "Female", "status": "Warning"},
    {"name": "Max", "role": "Commander (CMO,IV2)", "age": 47, "gender": "Female", "status": "Critical"},
    {"name": "Nathan", "role": "FE-2(IV1)", "age": 40, "gender": "Female", "status": "Normal"},
]


def run(simulation_name: str, updates:int=10, delay:float=1.0):
    from streamlit_autorefresh import st_autorefresh
    st_autorefresh(interval=60000, limit=None, key="vitals_autorefresh")
